...
export { getSearchClient, isSearchAvailable, checkSearchHealth, syncSchemas, upsertDocument, deleteDocument, reindexCollection, clearCollection, searchCollections, searchSuggest, extractText, type SearchParams, type SearchHit, type CollectionSearchResult, type GlobalSearchResult, type SuggestResult, } from './search';
