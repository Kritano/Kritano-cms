...
export type PluginHookEvent = 'content.beforeCreate' | 'content.afterCreate' | 'content.beforeUpdate' | 'content.afterUpdate' | 'content.beforePublish' | 'content.afterPublish' | 'content.beforeUnpublish' | 'content.afterUnpublish' | 'content.beforeDelete' | 'content.afterDelete' | 'media.afterUpload' | 'media.beforeDelete' | 'user.afterCreate' | 'form.afterSubmit' | 'cms.ready';
...
export type PluginConfigEntry = string | [string, PluginConfigOverride] | PluginDefinition;
