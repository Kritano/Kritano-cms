export type FieldType = 'text' | 'textarea' | 'richText' | 'slug' | 'url' | 'number' | 'boolean' | 'datetime' | 'select' | 'multiSelect' | 'media' | 'relation' | 'seoBlock' | 'blocks' | 'array' | 'colour';
...
export type FieldDefinition = TextFieldOptions | TextareaFieldOptions | RichTextFieldOptions | SlugFieldOptions | UrlFieldOptions | NumberFieldOptions | BooleanFieldOptions | DatetimeFieldOptions | SelectFieldOptions | MultiSelectFieldOptions | MediaFieldOptions | RelationFieldOptions | SeoBlockFieldOptions | BlocksFieldOptions | ArrayFieldOptions | ColourFieldOptions;
